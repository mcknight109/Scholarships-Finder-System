            ...
            <div class="login-container">
                <form action="reset-password.php" method="POST">
                    ...
                    <div class="login-input">
                        ...
                        <input type="password" name="new_password" placeholder="Enter your new password" max="30" onkeydown="return event.key !== ' ';">
                    </div>
                    <div class="login-input">
                        ...
                        <input type="password" name="confirm_password" placeholder="Confirm your new password" max="30" onkeydown="return event.key !== ' ';">
                    </div>
                    <div class="login-btn">
